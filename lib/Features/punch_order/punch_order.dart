...
class _PunchOrderViewState extends State<PunchOrderView> {
  final List<Product> _products = [
    Product(
      title: 'Mezan Hardum',
      sku: 'SKU001',
      imageUrl: 'assets/product1-removebg-preview.png',
      price: 29.99,
    ),
    Product(
      title: 'Mezan Ultra Rich',
      sku: 'SKU002',
      imageUrl: 'assets/product2-removebg-preview.png',
      price: 49.99,
    ),
    Product(
      title: 'Mezan Danedar',
      sku: 'SKU003',
      imageUrl: 'assets/product3-removebg-preview.png',
      price: 19.99,
    ),
    Product(
      title: 'Hardum Mixture',
      sku: 'SKU004',
      imageUrl: 'assets/product4-removebg-preview.png',
      price: 39.99,
    ),
    Product(
      title: 'Hardum Mix 5',
      sku: 'SKU005',
      imageUrl: 'assets/product5-removebg-preview.png',
      price: 39.99,
    ),
    Product(
      title: 'Hardum Mix 6',
      sku: 'SKU006',
      imageUrl: 'assets/product6-removebg-preview.png',
      price: 39.99,
    ),
  ];
